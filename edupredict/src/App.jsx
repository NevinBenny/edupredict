...
const LeafMark = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path d="M11 9.5C11 9.5 12 7.5 15 6" stroke="#2563eb" strokeWidth="1.2" strokeLinecap="round" />
  </svg>
)
  ...
  return (
    <div className="auth-shell">
      <div className="hero-side">
        <img src={heroImage} alt="Educational dashboard" />
        <div className="hero-copy">
          <p className="hero-title">Predicting Success</p>
          <p className="hero-sub">Access your AI-powered educational prediction system.</p>
        </div>
      </div>
